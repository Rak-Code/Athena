...
const MyProfile = () => {
  ...
  return (
    <Container className="py-5" style={{ maxWidth: "1400px" }}>
      {/* Page Title */}
      <h2 className="mb-5 fw-bold text-dark">My Profile</h2>
        ...
        <Row>
          ...
          <Col md={3} className="mb-4">
            ...
            <Nav className="flex-column">
              ...
              {/* PREFERENCES SECTION */}
              <h6 className="text-uppercase text-muted mt-4 mb-2 px-3">
                Preferences
              </h6>
              <Nav.Item>
                <Nav.Link eventKey="emailPreferences" className="py-2 px-3">
                  Email Preferences
                </Nav.Link>
              </Nav.Item>
              <Nav.Item>
                <Nav.Link eventKey="textMessagePreferences" className="py-2 px-3">
                  Text Message Preferences
                </Nav.Link>
              </Nav.Item>
              <Nav.Item>
                <Nav.Link eventKey="pushNotificationPreferences" className="py-2 px-3">
                  Push Notification Preferences
                </Nav.Link>
              </Nav.Item>
              <Nav.Item>
                <Nav.Link eventKey="appPreferences" className="py-2 px-3">
                  App Preferences
                </Nav.Link>
              </Nav.Item>
              ...
              <Nav.Item>
                <Nav.Link eventKey="orderHistory" className="py-2 px-3 d-flex align-items-center">
                  Order History
                  {orders.length > 0 && (
              ...
              <Nav.Item>
                <Nav.Link eventKey="threadPoints" className="py-2 px-3">
                  Thread Points
                </Nav.Link>
              </Nav.Item>
              <Nav.Item>
                <Nav.Link eventKey="threadPay" className="py-2 px-3">
                  Thread Pay
                </Nav.Link>
              </Nav.Item>
              ...
              <Nav.Item className="mt-4">
                <Nav.Link eventKey="wishlist" className="py-2 px-3 d-flex align-items-center">
                  My Wishlist
                  {wishlist.length > 0 && (
                    <Badge bg="dark" className="ms-auto">
                      {wishlist.length}
              ...
              <Nav.Item>
                <Nav.Link eventKey="reviews" className="py-2 px-3 d-flex align-items-center">
                  My Reviews
                  {reviews.length > 0 && (
                    <Badge bg="dark" className="ms-auto">
                      {reviews.length}
